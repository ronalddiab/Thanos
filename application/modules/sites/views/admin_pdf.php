...
$fuel_oil_kgco2 = GetSiteUtilityUnitNameKgCO2e($site_detail['id'],'electricity');//GetSiteUtilityUnitNameKgCO2e($site_id,'fuel_oil');
$lpg_kgco2 = GetSiteUtilityUnitNameKgCO2e($site_detail['id'],'electricity');//GetSiteUtilityUnitNameKgCO2e($site_id,'lpg');
$natural_gas_kgco2 = GetSiteUtilityUnitNameKgCO2e($site_detail['id'],'electricity');//GetSiteUtilityUnitNameKgCO2e($site_id,'natural_gas');
$district_cooling_kgco2 = GetSiteUtilityUnitNameKgCO2e($site_detail['id'],'electricity');//GetSiteUtilityUnitNameKgCO2e($site_id,'district_cooling');
$district_heating_kgco2 = GetSiteUtilityUnitNameKgCO2e($site_detail['id'],'electricity');//GetSiteUtilityUnitNameKgCO2e($site_id,'district_heating');
?>
