                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="35%"><strong>Cost (<?php echo CURRENCY.CURRENCY_SYMBOL ?>)</strong></td>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="35%"><?php echo CURRENCY_SYMBOL.' '.number_format($cost_pie_chart_previousmonth['electricity']); ?></td>
                                                                <td width="20%"><?php echo $kwh_pie_chart_previousmonth_cost_electricity_share; ?>%</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Fuel</td>
                                                                <td><?php echo CURRENCY_SYMBOL.' '.number_format($cost_pie_chart_previousmonth['fuel']); ?></td>
                                                                <td><?php echo $kwh_pie_chart_previousmonth_cost_fuel_share; ?>%</td>
                                                            </tr>
                                                            <tr>
                                                                <td>LPG</td>
                                                                <td><?php echo CURRENCY_SYMBOL.' '.number_format($cost_pie_chart_previousmonth['lpg']); ?></td>
                                                                <td><?php echo $kwh_pie_chart_previousmonth_cost_lPG_share; ?>%</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Natural Gas</td>
                                                                <td><?php echo CURRENCY_SYMBOL.' '.number_format($cost_pie_chart_previousmonth['natural_gas']); ?></td>
                                                                <td><?php echo $kwh_pie_chart_previousmonth_cost_gas_share; ?>%</td>
                                                            </tr>
                                                            <tr>
                                                                <td>District Heating</td>
                                                                <td><?php echo CURRENCY_SYMBOL.' '.number_format($cost_pie_chart_previousmonth['heating_district']); ?></td>
                                                                <td><?php echo $kwh_pie_chart_previousmonth_cost_heating_share; ?>%</td>
                                                            </tr>
                                                            <tr>
                                                                <td>District Cooling</td>
                                                                <td><?php echo CURRENCY_SYMBOL.' '.number_format($cost_pie_chart_previousmonth['cooling_district']); ?></td>
                                                                <td><?php echo $kwh_pie_chart_previousmonth_cost_cooling_share; ?>%</td>
                                                            </tr>
                                                            <tr>
                                                                <td>Water</td>
                                                                <td><?php echo CURRENCY_SYMBOL.' '.number_format($cost_pie_chart_previousmonth['water']); ?></td>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="35%"><strong><?php echo CURRENCY_SYMBOL.' '.number_format($cost_pie_chart_previousmonth_t_sum); ?></strong></td>                                                                
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
