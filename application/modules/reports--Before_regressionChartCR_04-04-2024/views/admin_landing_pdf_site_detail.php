		...
		<td>
			...
			<tr>
				...
				<table width="100%" cellpadding="0" cellspacing="0">
					...
					<td width="33%"><strong><?php echo lang('total-built-up-area').'('.getLocalUnitText($site_detail['id']).')'; ?></strong></td>
			...
			<tr>
			    <td><strong><?php echo lang('cooled-built-up-area').'('.getLocalUnitText($site_detail['id']).')'; ?></strong></td>
			    <td>
				<table width="100%" cellpadding="0" cellspacing="0">
				    <tr>
					<td width="33%"><?php echo $site_detail['cooled_builtup_area']; ?></td>
					<td width="33%"><strong><?php echo lang('total-meeting-area').'('.getLocalUnitText($site_detail['id']).')'; ?></strong></td>
			...
			<tr>
			    <td><strong><?php echo lang('spa-area').'('.getLocalUnitText($site_detail['id']).')'; ?></strong></td>
			    <td >
				<table width="100%" cellpadding="0" cellspacing="0">
				    <tr>
			...
			<tr>
			    <td><strong><?php echo lang('indoor-parking-area').'('.getLocalUnitText($site_detail['id']).')'; ?></strong></td>
			    <td>
				<table width="100%" cellpadding="0" cellspacing="0">
				    <tr>
