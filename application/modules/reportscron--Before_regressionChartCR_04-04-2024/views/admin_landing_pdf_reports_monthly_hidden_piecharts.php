...
?>
<?php 
$kwh_pie_chart_electricity_value = $kwh_pie_chart_previousmonth['electricity'];
$kwh_pie_chart_fuel_value = $kwh_pie_chart_previousmonth['fuel'];
$kwh_pie_chart_lpg_value = $kwh_pie_chart_previousmonth['lpg'];
$kwh_pie_chart_natural_gas_value = $kwh_pie_chart_previousmonth['natural_gas'];
$kwh_pie_chart_heating_district_value = $kwh_pie_chart_previousmonth['heating_district'];
$kwh_pie_chart_cooling_district_value = $kwh_pie_chart_previousmonth['cooling_district'];
...
$cost_share = ($kwh_pie_chart_previousmonth_cost_water_share+
    $kwh_pie_chart_previousmonth_cost_cooling_share+
    $kwh_pie_chart_previousmonth_cost_electricity_share+
    $kwh_pie_chart_previousmonth_cost_fuel_share+
    $kwh_pie_chart_previousmonth_cost_lPG_share+
    $kwh_pie_chart_previousmonth_cost_gas_share+
    $kwh_pie_chart_previousmonth_cost_heating_share);
?>
                ...
                <tr>
                    <td width="100%">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td width="50%"><img height="350" src="<?php echo $pieChartNew2Img; ?>" /></td>
                                <td width="50%"><img height="350" src="<?php echo $pieChartNew3Img; ?>" /></td>
                            </tr>
                            <tr>
                                <td valign="top">
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="24%"><?php echo is_nan($kwh_pie_chart_previousmonth_electricity_share) ? 0 : $kwh_pie_chart_previousmonth_electricity_share; ?>%</td>
                                                            </tr>
                                                            <?php } ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo is_nan($kwh_pie_chart_previousmonth_fuel_share) ? 0 : $kwh_pie_chart_previousmonth_fuel_share; ?>%</td>
                                                            </tr>
                                                            <?php } ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo is_nan($kwh_pie_chart_previousmonth_lpg_share) ? 0 : $kwh_pie_chart_previousmonth_lpg_share; ?>%</td>
                                                            </tr>
                                                            <?php } ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo is_nan($kwh_pie_chart_previousmonth_natural_gas_share) ? 0 : $kwh_pie_chart_previousmonth_natural_gas_share; ?>%</td>
                                                            </tr>
                                                            <?php } ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo is_nan($kwh_pie_chart_previousmonth_heating_district_share) ? 0 : $kwh_pie_chart_previousmonth_heating_district_share; ?>%</td>
                                                            </tr>
                                                            <?php } ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?php echo is_nan($kwh_pie_chart_previousmonth_cooling_district_share) ? 0 : $kwh_pie_chart_previousmonth_cooling_district_share; ?>%</td>
                                                            </tr>
                                                            <?php } ?>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="24%"><strong><?php echo is_nan(min($total_share,100)) ? 0 : min($total_share,100); ?>%</strong></td>               
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="35%"><strong>Cost (<?php echo REPORT_CURRENCY.REPORT_CURRENCY_SYMBOL ?>)</strong></td>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td width="20%"><?php echo number_format(min($cost_share,100)); ?>%</td>
                                                            </tr>
                                                        </tbody>
                                                    </table>
                                                </td>
