                                ...
                                <tbody>
                                    ...
                                    foreach ($utilities_list as $key=>$value) {
                                        ...
                                        <tr>
                                            ...
                                            ?>
                                                <th align="center" style="border-right-color:#000000;border-right-width:1px;border-right-style:solid;"><?php echo REPORT_CURRENCY_SYMBOL.number_format($year_value[$key]); ?></th>
                                            <?php
                                            }
                                            ?>
                                        </tr>
                                    ...
                                    <tr>
                                        ...
                                        ?>
                                            <th align="center" style="border-top-color:#000000;border-top-width:1px;border-top-style:solid;border-bottom-color:#000000;border-bottom-width:1px;border-bottom-style:solid;border-right-color:#000000;border-right-width:1px;border-right-style:solid;"><strong><?php echo REPORT_CURRENCY_SYMBOL.number_format($total); ?></strong></th>
                                        <?php
                                        }
                                        ?>
                                    </tr>
                                    ...
                                    <tr>
                                        <td style="border-left-color:#000000;border-left-width:1px;border-left-style:solid;border-right-color:#000000;border-right-width:1px;border-right-style:solid;">Electricity Tariff (<?php echo REPORT_CURRENCY_SYMBOL ?>/<?php echo GetSiteUtilityUnitName($site_id,'electricity'); ?>)</td>
                                        <?php 
                                        foreach ($utility_cost_chart_5years as $year => $year_value) {
                                        ?>
                                            <td align="center" style="border-right-color:#000000;border-right-width:1px;border-right-style:solid;"><?php echo REPORT_CURRENCY_SYMBOL.' '.round($year_value['electricity_tariff'], 2); ?></td>
                                        <?php
                                        }
                                        ?>
                                    </tr>
                                    ...
                                    <?php } ?>
                                    <tr>
                                        <td style="border-left-color:#000000;border-left-width:1px;border-left-style:solid;border-right-color:#000000;border-right-width:1px;border-right-style:solid;">Utilities Cost ($) / Room Night</td>
                                        <?php 
                                        foreach ($utility_cost_chart_5years as $year => $year_value) {
                                            $total = 0;
                                            foreach ($utilities_list as $key=>$value) {
