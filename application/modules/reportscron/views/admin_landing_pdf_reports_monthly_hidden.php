...
if (!empty($utility_cost_chart)) {
    ...
    foreach ($resultkeys as $year => $value) {
        ...
        foreach ($value as $key1 => $month) {
            ...
            $pre_data_guest_night_budget = (!empty($utility_cost_chart[$month][$year - 1]['total_guests_budget'])) ? $utility_cost_chart[$month][$year - 1]['total_guests_budget'] : 0;
    ...
    if (!empty($total_sum_data_fuel) && $total_sum_data_fuel_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_fuel) && $total_sum_pre_data_fuel_consumption != 0) {
    ...
    if (!empty($total_sum_data_lpg) && $total_sum_data_lpg_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_lpg) && $total_sum_pre_data_lpg_consumption != 0) {
    ...
    if (!empty($total_sum_data_natural_gas) && $total_sum_data_natural_gas_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_natural_gas) && $total_sum_pre_data_natural_gas_consumption != 0) {
    ...
    if (!empty($total_sum_data_heating_district) && $total_sum_data_heating_district_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_heating_district) && $total_sum_pre_data_heating_district_consumption != 0) {
    ...
    if (!empty($total_sum_data_cooling_district) && $total_sum_data_cooling_district_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_cooling_district) && $total_sum_pre_data_cooling_district_consumption != 0) {
    ...
    if (!empty($total_sum_data_water) && $total_sum_data_water_consumption != 0) {
    ...
    if (!empty($total_sum_pre_data_water) && $total_sum_pre_data_water_consumption != 0) {
    ...
    if ($total_sum_pre_data_room_night != 0 && !empty($total_sum_pre_data_electricity_kwh)) {
    ...
    if ($site_detail['site_builtup_area'] != 0 && !empty($total_sum_pre_data_electricity_kwh)) {
    ...
    if ($total_sum_pre_data_room_night != 0 && !empty($total_sum_pre_data_water)) {
...
if ($showCostBudgetVariance) {
    ...
    $electricity_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != '' && $currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_electricity_kwh_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $fuel_oil_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != '' && $currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_fuel_oil_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $lpg_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != '' && $currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_lpg_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;

    $natural_gas_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != '' && $currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["total_natural_gas_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;
    ...
    $district_cooling_per_room_night_actual = ($currentBudgetActualData["total_room_night"] != 0) ? round($currentBudgetActualData["district_cooling_cost_actual"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;
    ...
    $district_cooling_per_room_night_budget = $currentBudgetActualData["total_room_night"] != 0 ? round($currentBudgetActualData["district_cooling_cost_budget"] / $currentBudgetActualData["total_room_night"], $percentage_decimal) : 0;
