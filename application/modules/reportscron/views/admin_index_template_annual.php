...
<?php if (!empty($utility_cost_chart_pre)) {
	...
	foreach ($value as $key1 => $month) {
		...
		$pre_data_carbon_annual_electricity = ($pre_data_carbon_annual_electricity > 0) ? round($pre_data_carbon_annual_electricity  * $dataFactor['electricity'] * $site_detail['electricity_emission_factor'], 2) : 0;
 
		$pre_data_carbon_annual_fuel = ($pre_data_carbon_annual_fuel > 0) ? round($pre_data_carbon_annual_fuel  * $dataFactor['fuel_oil'] * $site_detail['fuel_emission_factor'], 2) : 0;
 
		$pre_data_carbon_annual_lpg = ($pre_data_carbon_annual_lpg > 0) ? round($pre_data_carbon_annual_lpg  * $dataFactor['lpg'] * $site_detail['lpg_emission_factor'], 2) : 0;
 
		$pre_data_carbon_annual_natural_gas = ($pre_data_carbon_annual_natural_gas > 0) ? round($pre_data_carbon_annual_natural_gas  * $dataFactor['natural_gas'] * $site_detail['natural_gas_emission_factor'], 2) : 0;
 
		$pre_data_carbon_annual_heating_district = ($pre_data_carbon_annual_heating_district > 0) ? round($pre_data_carbon_annual_heating_district  * $dataFactor['district_heating'] * $site_detail['district_heating_emission_factor'], 2) : 0;
 
		$pre_data_carbon_annual_cooling_district = ($pre_data_carbon_annual_cooling_district > 0) ? round($pre_data_carbon_annual_cooling_district  * $dataFactor['district_cooling'] * $site_detail['district_cooling_emission_factor'], 2) : 0;
 


		$data_carbon_annual_electricity = ($data_carbon_annual_electricity > 0) ? round($data_carbon_annual_electricity  * $dataFactor['electricity'] * $site_detail['electricity_emission_factor'], 2) : 0;
 
		$data_carbon_annual_fuel = ($data_carbon_annual_fuel > 0) ? round($data_carbon_annual_fuel  * $dataFactor['fuel_oil'] * $site_detail['fuel_emission_factor'], 2) : 0;
 
		$data_carbon_annual_lpg = ($data_carbon_annual_lpg > 0) ? round($data_carbon_annual_lpg  * $dataFactor['lpg'] * $site_detail['lpg_emission_factor'], 2) : 0;
 
		$data_carbon_annual_natural_gas = ($data_carbon_annual_natural_gas > 0) ? round($data_carbon_annual_natural_gas  * $dataFactor['natural_gas'] * $site_detail['natural_gas_emission_factor'], 2) : 0;
 
		$data_carbon_annual_heating_district = ($data_carbon_annual_heating_district > 0) ? round($data_carbon_annual_heating_district  * $dataFactor['district_heating'] * $site_detail['district_heating_emission_factor'], 2) : 0;
 
		$data_carbon_annual_cooling_district = ($data_carbon_annual_cooling_district > 0) ? round($data_carbon_annual_cooling_district  * $dataFactor['district_cooling'] * $site_detail['district_cooling_emission_factor'], 2) : 0;
	...
	console.log("arrValuesMulti",arrValuesMulti)
