<?php $positive_number_style = "color:red;"; ?>
    ...
    <body width="100%">
        ...
        <div style="border:2px solid  #f69546;padding:6px;">
            <table width="100%" cellpadding="1" cellspacing="2"><?php
                ...
                <tr align="center">
                    <td width="100%">
                        <img src="<?php //echo $columnChartImg_month; ?>" />
                    </td>
                </tr>
                <tr>
                    <td width="100%"><?php
                            ...
                            ?><table border="1" width="100%" cellpadding="2" cellspacing="0" style="font-size:6px;">
                                <thead>
                                    <tr style="background-color:#d8e1f2;">
                                        ...
                                        <th width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                <thead>
                                                    <tr>
                                        ...
                                        <th width="30%"><table width="100%" cellpadding="2" cellspacing="0">
                                                <thead>
                                                    <tr align="center" style="background-color: #9fb6df;"><th colspan="3"><strong>Difference v/s Last Year</strong></th></tr>
                                                    <tr align="center">
                                        ...
                                        <th width="20%"><table width="100%" cellpadding="2" cellspacing="0">
                                                <thead>
                                                    <tr align="center" style="background-color: #9fb6df;"><th colspan="2"><strong>Difference v/s Budget</strong></th></tr>
                                                    <tr align="center">
                                ...
                                <tbody>
                                    <tr>
                                        <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    <tr><td>Room Nights</td></tr>
                                                    <tr><td>Guest Nights</td></tr>
                                                    <tr><td>CDD</td></tr>
                                                    <tr><td>HDD</td></tr>
                                                </tbody>
                                            </table>
                                        ...
                                        <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        <td width="35%"><?php echo number_format($total_sum_data_cdd); ?></td>
                                                        <td width="35%"><?php echo number_format($total_sum_pre_data_cdd); ?></td>
                                                        <td width="30%"></td>
                                                    </tr>
                                                    <tr>
                                                        <td width="35%"><?php echo number_format($total_sum_data_hdd); ?></td>
                                                        <td width="35%"><?php echo number_format($total_sum_pre_data_hdd); ?></td>
                                                        <td width="30%"></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                    ...
                                    <?php if ($site_detail['show_utility_electricity']) { ?>
                                        ...
                                        <tr>
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                    <tr><td>Consumption (<?php echo GetSiteUtilityUnitName($site_id,'electricity'); ?>)</td></tr>
                                                    <tr><td>Average tariff (<?php echo cur_symbol($isLocal) ?> / <?php echo GetSiteUtilityUnitName($site_id,'electricity'); ?>)</td></tr>
                                                    <tr><td>Total Cost (<?php echo cur_symbol($isLocal) ?>)</td></tr>
                                                    <tr><td>Consumption/Room Night (<?php echo GetSiteUtilityUnitName($site_id,'electricity'); ?>)</td></tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            <td width="35%"><?php echo number_format($total_sum_data_electricity_kwh); ?></td>
                                                        ...
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_electricity_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_electricity_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($electricity_tariff_budget, $value_decimal, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_electricity, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_electricity, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($currentBudgetActualData["total_electricity_cost_budget"], 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr style="<?php echo $electricity_consumption_difference > 0 ? $positive_number_style : ''; ?>">
                                                            ...
                                                            <td width="30%" align="center"><?php echo numb_format_without_currency($electricity_ly, 0, $isLocal); ?></td>
                                                        </tr>
                                                        ...
                                                        <tr style="<?php echo $electricity_tariff_cl_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($electricity_tariff_cl_diff, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $electricity_cost_cl_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($electricity_cost_cl_diff, 0, $isLocal); ?></td>
                                            ...
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr style="<?php echo $electricity_actual_budget_tariff_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($electricity_actual_budget_tariff_diff, $value_decimal, $isLocal); ?></td>
                                                            <td style="text-align: center;"><?php echo number_format($electricity_tariff_variation, $percentage_decimal) . "%"; ?></td>
                                                        </tr>
                                                        ...
                                                        <tr style="text-align: center;<?php echo $elecricity_act_bud_cost_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td><?php echo numb_format_without_currency($elecricity_act_bud_cost_diff, 0, $isLocal); ?></td>
                                    ...
                                    <?php } if ($site_detail['show_utility_fuel_oil']) { ?>
                                        ...
                                        <tr>
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr><td>Consumption (<?php echo GetSiteUtilityUnitName($site_id,'fuel_oil'); ?>)</td></tr>
                                                        <tr><td>Average tariff  (<?php echo cur_symbol($isLocal) ?> / <?php echo GetSiteUtilityUnitName($site_id,'fuel_oil'); ?>)</td></tr>
                                                        <tr><td>Total Cost (<?php echo cur_symbol($isLocal) ?>)</td></tr>
                                                        <tr><td>Consumption/Room Night (<?php echo GetSiteUtilityUnitName($site_id,'fuel_oil'); ?>)</td></tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_fuel_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_fuel_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($fuel_oil_tariff_budget, $value_decimal, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_fuel, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_fuel, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($currentBudgetActualData["total_fuel_oil_cost_budget"], 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr style="<?php echo $fuel_consumption_difference > 0 ? $positive_number_style : ''; ?>">
                                                            ...
                                                            <td width="30%" align="center"><?php echo numb_format_without_currency($fuel_oil_ly, 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr style="<?php echo $fuel_difference > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($fuel_difference, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $fuel_cost_cl_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($fuel_cost_cl_diff, 0, $isLocal); ?></td>
                                            ...
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr style="<?php echo $fuel_act_bud_tariff_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($fuel_act_bud_tariff_diff, $value_decimal, $isLocal); ?></td>
                                                            <td style="text-align: center;"><?php echo number_format($fuel_oil_tariff_variation, $percentage_decimal) . "%"; ?></td>
                                                        </tr>
                                                        ...
                                                        <tr style="<?php $fuel_act_bud_cost_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($fuel_act_bud_cost_diff, 0, $isLocal); ?></td>
                                                            <td style="text-align: center;"><?php echo number_format($fuel_oil_cost_variation, $percentage_decimal) . "%"; ?></td>
                                                        </tr>
                                                        ...
                                                        <tr style="<?php echo $fuel_act_bud_rn_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($fuel_act_bud_rn_diff, $percentage_decimal, $isLocal); ?></td>
                                    ...
                                    <?php } if ($site_detail['show_utility_lpg']) { ?>
                                        ...
                                        <tr>
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr><td>Consumption (<?php echo GetSiteUtilityUnitName($site_id,'lpg'); ?>)</td></tr>
                                                        <tr><td>Average tariff (<?php echo cur_symbol($isLocal) ?> / <?php echo GetSiteUtilityUnitName($site_id,'lpg'); ?>)</td></tr>
                                                        <tr><td>Total Cost (<?php echo cur_symbol($isLocal) ?>)</td></tr>
                                                        <tr><td>Consumption/Room Night (<?php echo GetSiteUtilityUnitName($site_id,'lpg'); ?>)</td></tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_lpg_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_lpg_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($lpg_tariff_budget, $value_decimal, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_lpg, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_lpg, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($currentBudgetActualData["total_lpg_cost_budget"], 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr style="<?php echo $lpg_consumption_difference > 0 ? $positive_number_style : ''; ?>">
                                                            ...
                                                            <td width="30%" align="center"><?php echo numb_format_without_currency($lpg_ly, 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr style="<?php echo $lpg_difference > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($lpg_difference, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $lpg_cl_cost_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($lpg_cl_cost_diff, 0, $isLocal); ?></td>
                                            ...
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr style="<?php echo $lpg_act_bud_tarrif_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($lpg_act_bud_tarrif_diff, $value_decimal, $isLocal); ?></td>
                                                            <td style="text-align: center;"><?php echo number_format($lpg_tariff_variation, $percentage_decimal) . "%"; ?></td>
                                                        </tr>
                                                        ...
                                                        <tr style="<?php echo $lpg_act_bud_cost_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($lpg_act_bud_cost_diff, 0, $isLocal); ?></td>
                                    ...
                                    <?php } if ($site_detail['show_utility_natural_gas']) { ?>
                                        ...
                                        <tr>
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr><td>Consumption (<?php echo GetSiteUtilityUnitName($site_id,'natural_gas'); ?>)</td></tr>
                                                        <tr><td>Average tariff (<?php echo cur_symbol($isLocal) ?> / <?php echo GetSiteUtilityUnitName($site_id,'natural_gas'); ?>)</td></tr>
                                                        <tr><td>Total Cost (<?php echo cur_symbol($isLocal) ?>)</td></tr>
                                                        <tr><td>Consumption/Room Night (<?php echo GetSiteUtilityUnitName($site_id,'natural_gas'); ?>)</td></tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_natural_gas_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_natural_gas_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($natural_gas_tariff_budget, $value_decimal, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_natural_gas, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_natural_gas, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($currentBudgetActualData["total_natural_gas_cost_budget"], 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr style="<?php echo $natural_gas_consumption_difference > 0 ? $positive_number_style : ''; ?>">
                                                            ...
                                                            <td width="30%" align="center"><?php echo numb_format_without_currency($natural_gas_ly, 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr style="<?php echo $natural_gas_variation > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($natural_gas_difference, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $total_sum_data_natural_gas_variation > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($total_sum_data_natural_gas - $total_sum_pre_data_natural_gas, 0, $isLocal); ?></td>
                                            ...
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr style="<?php echo $natural_gas_act_bud_tariff_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($natural_gas_act_bud_tariff_diff, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $natural_gas_act_bud_cost_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($natural_gas_act_bud_cost_diff, 0, $isLocal); ?></td>
                                    ...
                                    <?php } if ($site_detail['show_utility_water']) { ?>
                                        ...
                                        <tr>
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr><td>Consumption (<?php echo GetSiteUtilityUnitName($site_id,'water'); ?>)</td></tr>
                                                        <tr><td>Average tariff (<?php echo cur_symbol($isLocal) ?> / <?php echo GetSiteUtilityUnitName($site_id,'water'); ?>)</td></tr>
                                                        <tr><td>Total Cost (<?php echo cur_symbol($isLocal) ?>)</td></tr>
                                                        <tr><td>Consumption/Room Night (<?php echo GetSiteUtilityUnitName($site_id,'water'); ?>)</td></tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr>
                                                            <td width="35%"><?php echo number_format($total_sum_data_water_consumption); ?></td>
                                                            <td width="35%"><?php echo number_format($total_sum_pre_data_water_consumption); ?></td>
                                                            <td width="30%"><?php echo number_format($currentBudgetActualData["water_total_consumption_budget"]); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_water_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_water_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($water_tariff_budget, $value_decimal, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_water, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_water, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($currentBudgetActualData["water_total_consumption_cost_budget"], 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr style="<?php echo $water_consumption_difference > 0 ? $positive_number_style : ''; ?>">
                                                            ...
                                                            <td width="30%" align="center"><?php echo numb_format_without_currency($water_ly, 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr style="<?php echo $water_difference > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($water_difference, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $total_sum_data_water_variation > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($total_sum_data_water - $total_sum_pre_data_water, 0, $isLocal); ?></td>
                                            ...
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr style="<?php echo $water_act_bud_tariff_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($water_act_bud_tariff_diff, $value_decimal, $isLocal); ?></td>
                                                            <td style="text-align: center;"><?php echo number_format($water_tariff_variation, $percentage_decimal) . "%"; ?></td>
                                                        </tr>
                                                        ...
                                                        <tr style="<?php echo $water_act_bud_cost_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($water_act_bud_cost_diff, 0, $isLocal); ?></td>
                                    ...
                                    <?php } if ($site_detail['show_utility_district_cooling']) { ?>
                                        ...
                                        <tr>
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr><td>Consumption (<?php echo GetSiteUtilityUnitName($site_id,'district_cooling'); ?>)</td></tr>
                                                        <tr><td>Average tariff (<?php echo cur_symbol($isLocal) ?> / <?php echo GetSiteUtilityUnitName($site_id,'district_cooling'); ?>)</td></tr>
                                                        <tr><td>Total Cost (<?php echo cur_symbol($isLocal) ?>)</td></tr>
                                                        <tr><td>Consumption/Room Night (<?php echo GetSiteUtilityUnitName($site_id,'district_cooling'); ?>)</td></tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_cooling_district_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_cooling_district_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($district_cooling_tariff_budget, $value_decimal, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <!--<td><?php echo numb_format_without_currency($currentBudgetActualData["district_cooling_cost_actual"], 0, $isLocal); ?></td>-->
                                                            <td><?php echo num_format_without_currency($total_sum_data_cooling_district, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_cooling_district, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($currentBudgetActualData["district_cooling_cost_budget"], 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr style="<?php echo $cooling_district_consumption_difference > 0 ? $positive_number_style : ''; ?>">
                                                            ...
                                                            <td width="30%" align="center"><?php echo numb_format_without_currency($cooling_district_ly, 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr style="<?php echo $cooling_district_difference > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($cooling_district_difference, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $total_sum_data_cooling_district_variation > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($total_sum_data_cooling_district - $total_sum_pre_data_cooling_district, 0, $isLocal); ?></td>
                                            ...
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <?php 
                                                        $district_cooling_act_bud_diff = $total_sum_data_cooling_district_consumption - $currentBudgetActualData["district_cooling_budget"]; 
                                                        ?>
                                                        ...
                                                        <tr style="<?php echo $district_cooling_act_bud_tariff_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($district_cooling_act_bud_tariff_diff, $value_decimal, $isLocal); ?></td>
                                                            <td style="text-align: center;"><?php echo number_format($district_cooling_tariff_variation, $percentage_decimal) . "%"; ?></td>
                                                        </tr>
                                                        <?php 
                                                        ...
                                                        <tr style="<?php echo $district_cooling_act_bud_cost_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($district_cooling_act_bud_cost_diff, 0, $isLocal); ?></td>
                                                            <td style="text-align: center;"><?php echo number_format($district_cooling_cost_variation, $percentage_decimal) . "%"; ?></td>
                                                        </tr>
                                    ...
                                    <?php } if ($site_detail['show_utility_district_heating']) { ?>
                                        ...
                                        <tr>
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr><td>Consumption (<?php echo GetSiteUtilityUnitName($site_id,'district_heating'); ?>)</td></tr>
                                                        <tr><td>Average tariff (<?php echo cur_symbol($isLocal) ?> / <?php echo GetSiteUtilityUnitName($site_id,'district_heating'); ?>)</td></tr>
                                                        <tr><td>Total Cost (<?php echo cur_symbol($isLocal) ?>)</td></tr>
                                                        <tr><td>Consumption/Room Night (<?php echo GetSiteUtilityUnitName($site_id,'district_heating'); ?>)</td></tr>
                                                    </tbody>
                                                </table>
                                            </td>
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_heating_district_tariff, $value_decimal, $isLocal); ?></td>                                                            
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_heating_district_tariff, $value_decimal, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($district_heating_tariff_budget, $value_decimal, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                                            <td><?php echo numb_format_without_currency($total_sum_data_heating_district, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($total_sum_pre_data_heating_district, 0, $isLocal); ?></td>
                                                            <td><?php echo numb_format_without_currency($currentBudgetActualData["district_heating_cost_budget"], 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr>
                                            ...
                                            <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        <tr style="<?php echo $heating_district_consumption_difference > 0 ? $positive_number_style : ''; ?>">
                                                            <td width="35%" align="center"><?php echo number_format($heating_district_consumption_difference);
                                                            ?></td>
                                                            <td width="35%" align="center"><?php echo number_format($heating_district_consumption_variation, $percentage_decimal); ?>%</td>
                                                            <td width="30%" align="center"><?php echo numb_format_without_currency($heating_district_ly, 0, $isLocal); ?></td>
                                                        </tr>
                                                        <tr style="<?php echo $heating_district_difference > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($heating_district_difference, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $total_sum_data_heating_district_variation > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($total_sum_data_heating_district - $total_sum_pre_data_heating_district, 0, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $heating_district_per_room_night_difference_value > 0 ? $positive_number_style : ''; ?>">
                                                            <td align="center"><?php echo numb_format_without_currency($heating_district_per_room_night_difference_value, $percentage_decimal, $isLocal); ?></td>
                                            ...
                                            <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                    <tbody>
                                                        ...
                                                        <tr style="<?php echo $district_heating_act_bud_tariff_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($district_heating_act_bud_tariff_diff, $value_decimal, $isLocal); ?></td>
                                                        ...
                                                        <tr style="<?php echo $district_heating_act_bud_cost_diff > 0 ? $positive_number_style : ''; ?>">
                                                            <td style="text-align: center;"><?php echo numb_format_without_currency($district_heating_act_bud_cost_diff, 0, $isLocal); ?></td>
                                    ...
                                    <tr style="font-weight: bold;color:blue;">
                                        <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                <tbody style="font-weight: bold;color:blue;">
                                                    <tr><td>Total Cost (<?php echo cur_symbol($isLocal) ?>)</td></tr>
                                                    <tr><td>Total Cost / Room Night</td></tr>
                                                    <tr><td>Total Cost / m<sup>2</sup> (<?php echo cur_symbol($isLocal) ?> / m<sup>2</sup>)</td></tr>
                                                </tbody>
                                            </table>
                                        </td>
                                        <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                <tbody style="font-weight: bold;color:blue;">
                                                    <tr>
                                                        <td width="35%"><?php echo numb_format_without_currency($total_sum_data_sum, 0, $isLocal); ?></td>
                                                        <td width="35%"><?php echo numb_format_without_currency($total_sum_pre_data_sum, 0, $isLocal); ?></td>
                                                        <td width="30%"><?php echo numb_format_without_currency($total_cost_budget, 0, $isLocal); ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><?php echo numb_format_without_currency($total_sum_data_utility_cost_per_roomnight, $percentage_decimal, $isLocal); ?></td>
                                                        <td><?php echo numb_format_without_currency($total_sum_pre_data_utility_cost_per_roomnight, $percentage_decimal, $isLocal); ?></td>
                                                        <td><?php //echo numb_format_without_currency($total_cost_budget_per_room_night, 0, $isLocal);        ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td><?php echo numb_format_without_currency($total_sum_data_utility_cost_per_m2, $percentage_decimal, $isLocal); ?></td>
                                                        <td><?php echo numb_format_without_currency($total_sum_pre_data_utility_cost_per_m2, $percentage_decimal, $isLocal); ?></td>
                                                        <td><?php //echo numb_format_without_currency($total_cost_budget_per_m2, $percentage_decimal, $isLocal);        ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
                                        <td width="30%"><table width="100%" cellpadding="0" cellspacing="0">
                                                <tbody style="font-weight: bold;color:blue;">
                                                    <tr>
                                                        <td width="35%" align="center" style="<?php echo $total_sum_difference_value > 0 ? $positive_number_style : ''; ?>"><?php echo numb_format_without_currency($total_sum_difference_value, 0, $isLocal); ?></td>
                                                        ...
                                                        <td width="30%" align="center" style="<?php echo $total_cost_ly > 0 ? $positive_number_style : ''; ?>"><?php echo numb_format_without_currency($total_cost_ly, 0, $isLocal); ?></td>
                                                    </tr>
                                                    <tr style="<?php echo $data_utility_cost_per_roomnight_difference > 0 ? $positive_number_style : ''; ?>">
                                                        <td align="center"><?php echo numb_format_without_currency($data_utility_cost_per_roomnight_difference, $percentage_decimal, $isLocal); ?></td>
                                                        <td align="center"><?php echo number_format($data_utility_cost_per_roomnight_variation, $percentage_decimal); ?>%</td>
                                                        <td align="center"></td>
                                                    </tr>
                                                    <tr style="<?php echo $data_utility_cost_per_m2_difference > 0 ? $positive_number_style : ''; ?>">
                                                        <td align="center"><?php echo numb_format_without_currency($data_utility_cost_per_m2_difference, $percentage_decimal, $isLocal); ?></td>
                                        ...
                                        <td width="20%"><table width="100%" cellpadding="0" cellspacing="0">
                                                <tbody style="font-weight: bold;color:blue;">
                                                    ...
                                                    $variation_percentage = $total_cost_budget != 0 ? round($variation * 100 / $total_cost_budget, $percentage_decimal) : 0;

                                                    ?>
                                                    <tr style="<?php echo $variation > 0 ? $positive_number_style : ''; ?>">
                                                        <td width="50%" align="center"><?php echo numb_format_without_currency($variation, 0, $isLocal); ?></td>
                                                        <td width="50%" align="center"><?php echo number_format($variation_percentage, $percentage_decimal) ?>%</td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center"><?php //echo number_format($total_cost_per_room_night_variation);        ?></td>
                                                        <td align="center"><?php //echo $total_cost_per_room_night_variation_percentage . "%";        ?></td>
                                                    </tr>
                                                    <tr>
                                                        <td align="center"><?php //echo $total_cost_per_m2_variation;        ?></td>
                                                        <td align="center"><?php //echo $total_cost_per_m2_variation_percentage . "%";        ?></td>
                                                    </tr>
                                                </tbody>
                                            </table>
                                        </td>
                ...
                <tr>
                    <td width="100%"><table border="1" width="100%" cellpadding="2" cellspacing="0" style="font-size:8px;">
                            <thead>
                                <tr><th style="background-color:#d8e1f2;" align="center"><strong>Notes.</strong></th></tr>
                            </thead><tbody>
                                <tr>
                                    <td width="100%">
