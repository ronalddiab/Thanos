                        ...
                        <div class="panel-body">
                            <div class="col-sm-12">
                                ...
                                <div class="col-sm-12" id="utility_chart_ocupancy_container" style="display: none;">
                                    <div id="utility_chart_occupancy_saveImage"></div>
...
<?php if (sizeof($chartData_cdd_hdd) > 1) { ?>
            ...
            var options = {
                height: 700,
                title: '<?php echo $utility_array[$utilityTitles[$utility_select[0]]['parent']]['Label'] . " (" . $utilityTitles[$utility_select[0]]['name'] . ") " ?>',
                titleTextStyle: {
                    fontName: 'Arial',
                    fontSize: 25
                },
