                    ...
                    <div class="col-sm-12">
                        ...
                        <div class="col-sm-2 gen-report" id="export">
                            ...
                            <form id="exportForm" action="<?php echo base_url() . BASE_ADMIN_URL_CUSTOM; ?>reports/export" method="POST">
				                ...
				                <?php if(!$export_reports_management_permission && $_SESSION['admin']['role_id'] != 1){ ?>
                    ...
                    <table class="table table-bordered table-font-18 padding-8-5">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                $last_year_guest_deference = $current_year['total_guests'] - $previous_year['total_guests'];

                                $last_year_guest_percantage = ($previous_year['total_guests'] != 0) ? (($last_year_guest_deference * 100) / $previous_year['total_guests']) : 0;

                                ?>

                                <th class="table-border-right table-border-left" scope="row">Guest Nights</th>

                                <td><?php echo number_format($current_year['total_guests']); ?></td>

                                <td><?php echo number_format($previous_year['total_guests']); ?></td>
