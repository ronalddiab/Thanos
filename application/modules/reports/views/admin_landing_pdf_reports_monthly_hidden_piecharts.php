                                            ...
                                            <tr>
                                                ...
                                                <th style="background-color:#d8e1f2;" align="center">
                                                    ...
                                                    <?php if ($type == "monthly") : ?>
														...
														<strong><?php echo 'Energy Consumption (kWh)' . ' - ' . $fullmontharray[$filters["report_month_piechart"]] . ' ' . $filters["report_year_piechart"]; ?></strong>

                                                    <?php else : ?>

														<strong><?php echo 'Energy Consumption (% Share Of Total kWh)' . ' - ' . $fullmontharray[$filters["report_month_piechart"]] . ' ' . $filters["report_year_piechart"]; ?></strong>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <?php if ($totalElectricity) { ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td width="24%"><?php echo floatval((string)$kwh_pie_chart_electricity_share); ?>%</td>
                                                            ...
                                                            <?php if ($totalFuel) { ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo floatval((string)$kwh_pie_chart_fuel_share); ?>%</td>
                                                            ...
                                                            <?php if ($totalLpg) { ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo floatval((string)$kwh_pie_chart_lpg_share); ?>%</td>
                                                            ...
                                                            <?php if ($totalNaturalGas) { ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo floatval((string)$kwh_pie_chart_natural_gas_share); ?>%</td>
                                                            ...
                                                            <?php if ($totalHeatingDistrict) { ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo floatval((string)$kwh_pie_chart_heating_district_share); ?>%</td>
                                                            ...
                                                            <?php if ($totalCoolingDistrict) { ?>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><?php echo floatval((string)$kwh_pie_chart_cooling_district_share); ?>%</td>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="24%"><strong><?php echo round(floatval((string)$total_share)); ?>%</strong></td>
                                    ...
                                    <table border="1" width="100%" cellpadding="2" cellspacing="0">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th style="background-color:#d8e1f2;" align="center"><strong><?php echo lang("cost-pie-chart-last12month-title") . ' - ' . $fullmontharray[$filters["report_month_piechart"]] . ' ' . $filters["report_year_piechart"]; ?></strong></th>
                                                    ...
                                                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td width="35%"><strong>Cost (<?php echo $isLocal ? currency_symbol($isLocal) : CURRENCY_SYMBOL; ?>)</strong></td>
